...
from causallearn.utils.PCUtils import Helper, Meek, UCSepset#, SkeletonDiscovery
import causallearn.utils.PCUtils.SkeletonDiscovery_Multiprocessing as SkeletonDiscovery
...
def pc_alg(
    ...
    **kwargs
    ...
    cg_1.PC_elapsed = time.time() - start
    #print(cg_1)
    return cg_1
    #print("PC_partition: ", time.time()-start)
    #return cg_1
    ...
    if uc_rule == 0:
        ...
        print("UC sepset time:", time.time()-st1)
